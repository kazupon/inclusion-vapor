...
export const runtimePublicPath: string = '/@react-refresh'
...
export const runtimeCode: string = `
const exports = {}
${fs.readFileSync(runtimeFilePath, 'utf8')}
${fs.readFileSync(_require.resolve('./refreshUtils.js'), 'utf8')}
...
`.replace(/\n+/g, '') // eslint-disable-line unicorn/prefer-string-replace-all
